...
export default function ApiKeysDocsPage() {
  return (
    <div className="doc-prose">
      <h2>API Keys</h2>
      <p className="lede">
        Keys authenticate your backend to the Cyrus API. Manage them from the dashboard; this page explains how they work.
      </p>
      <ul>
        <li>
          <b>Two environments.</b> <code>cyrus_test_</code> hits the sandbox; <code>cyrus_live_</code> hits production. Live
          keys exist only after you go live.
        </li>
        <li>
          <b>Shown once.</b> The full key is revealed a single time at creation — store it in your secret manager immediately.
        </li>
