...
export default function PaymentsReferencePage() {
  return (
    <div className="doc-prose">
      ...
      <div className="my-4 flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
        ...
        <span className="db db-warn">reconciled with Nomba</span><span>→</span>
        <span className="db db-good">payment.succeeded</span>
      </div>
      <p>
        Cyrus verifies the Nomba signature, discards duplicates, and matches the credited account number to a customer.
        The webhook alone is never treated as proof of payment — Cyrus independently requeries Nomba to confirm the
        transfer before your wallet is credited and <code>payment.succeeded</code> fires. Amounts are always integer
        kobo (₦50,000.00 = 5,000,000 kobo).
      </p>
      <Code>{`{
  ...
  "data": {
    ...
    "paidAt": "2026-07-07T20:39:02Z"
      ...
      <p>
        <code>amountKobo</code> is the gross amount the payer sent. Your wallet is credited net of two deductions: Nomba&apos;s
        own confirmed fee, and Cyrus&apos;s platform fee (a markup on top of it) — see the Wallet page in the dashboard for
        the exact split on any transaction.
      </p>
      <p>
